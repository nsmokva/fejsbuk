                            ...
                            <v-row>
                                <v-col cols="auto" align-self="center" class="pr-0">
                                    <v-avatar  color="secondary" size="35">
                                        <v-img :src="'/backend/user/images/' + this.photoname" height="35" width="35"></v-img>
                                    </v-avatar>
                                </v-col>
                                <v-col class="pl-0">
                                    <v-textarea v-model="newStatus" :placeholder="'What is on your mind ' + logedInUserName + '?'" solo flat hide-details rows="1"></v-textarea>
                                </v-col>
                            </v-row>
                    ...
                    <v-card flat outlined v-for="status in statuses" :key="status._id" class="mb-3">
                        <v-container >
                            ...
                            <v-row v-if="status.openCommentField" align="center">
                                <v-col cols="auto">
                                    <v-avatar  color="secondary" size="35">
                                        <v-img :src="'/backend/user/images/' + photoname" height="35" width="35"></v-img>
...
export default {
    ...
    props: ['id', 'firstName', 'lastName', 'photoname'],
    components:{
        Intro,
        Friends
    },
