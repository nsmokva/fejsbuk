        ...
        <v-container class="secondary" fluid>
            <v-container class="pt-0">
                ...
                <v-col cols="auto">
                    <v-avatar color="grey lighten-2" size="245" class="mt-12 ml-4 nina">
                        <v-avatar color="white" size="240">
                            <v-avatar size="230">
                                <!-- <v-img :src="require('../../public/' + this.firstName + '.jpg')"></v-img> -->
                            </v-avatar>
                        </v-avatar>
                    </v-avatar>
                </v-col>
                ...
                <v-row class="white" justify="end">
                    ...
                    <v-divider vertical></v-divider>
                   <v-col cols="auto" class="pa-0">
                       <v-list-item :to="{name: 'about'}"><v-list-item-content class="primary--text text-h6">About</v-list-item-content></v-list-item>   
                    </v-col>
                    <v-divider vertical></v-divider>
                   <v-col cols="auto" class="pa-0">
